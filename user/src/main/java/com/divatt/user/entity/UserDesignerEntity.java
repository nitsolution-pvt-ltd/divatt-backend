...
public class UserDesignerEntity {
	...
	@NotNull
	@Field(name = "user_id") private Long userId;
	@NotNull
	@Field(name = "designer_id") private Long designerId;
	@Field(name = "comment") private String comment;
	@Field(name = "raiting") private Long raiting;
	@NotNull
	@Field(name = "is_following") private Boolean isFollowing;
