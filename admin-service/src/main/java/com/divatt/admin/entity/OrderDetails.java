...
public class OrderDetails {
	...
	public OrderDetails(String datetime, int designer_id, int user_id, float discount, String payment_mode, float mrp,
			String order_id, String image, String invoice_id, int product_id, String product_sku, float sales_price,
			String size, String tax_type, int units, int hsn_rate, String hsn_code, float hsn_amount, float hsn_cgst,
			float hsn_sgst, float hsn_igst, float total_tax, String order_status, String delivery_datetime,
			String remarks, String productName) {
		super();
	...
	public String toString() {
		return "OrderDetails [datetime=" + datetime + ", designer_id=" + designer_id + ", user_id=" + user_id
				+ ", discount=" + discount + ", payment_mode=" + payment_mode + ", mrp=" + mrp + ", order_id="
				+ order_id + ", image=" + image + ", invoice_id=" + invoice_id + ", product_id=" + product_id
				+ ", product_sku=" + product_sku + ", sales_price=" + sales_price + ", size=" + size + ", tax_type="
				+ tax_type + ", units=" + units + ", hsn_rate=" + hsn_rate + ", hsn_code=" + hsn_code + ", hsn_amount="
				+ hsn_amount + ", hsn_cgst=" + hsn_cgst + ", hsn_sgst=" + hsn_sgst + ", hsn_igst=" + hsn_igst
				+ ", total_tax=" + total_tax + ", order_status=" + order_status + ", delivery_datetime="
				+ delivery_datetime + ", remarks=" + remarks + ", productName=" + productName + "]";
	}
