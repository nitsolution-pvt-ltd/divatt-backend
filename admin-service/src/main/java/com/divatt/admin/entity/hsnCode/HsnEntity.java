...
public class HsnEntity {
	...
	@NotNull(message = "tax_value is requried")
	...
	public HsnEntity(Integer id, @NotNull(message = "hsnCode is requried") Integer hsnCode,
			@NotNull(message = "description is requried") String description,
			@NotNull(message = "tax_value is requried") Double taxValue, Double sgst, Double cgst, Double igst,
	...
	public HsnEntity(@NotNull(message = "hsnCode is requried") Integer hsnCode,
			@NotNull(message = "description is requried") String description,
			@NotNull(message = "tax_value is requried") Double taxValue) {
		super();
		this.hsnCode = hsnCode;
		this.description = description;
		this.taxValue = taxValue;
