...
//	
	...
	List<DesignerProfileEntity> findByDesignerName(String designerName);

	List<DesignerProfileEntity> findByIsDeletedAndIsProfileCompletedAndDesignerCurrentStatusAndProfileStatus(Boolean isDeleted,
			Boolean isProfileCompleted, String designerCurrentStatus, String profileStatus);
	List<DesignerProfileEntity> findByIsDeleted(Boolean isDeleted);
	
	@Query("{'designer_profile.email':?0}")
	Optional<DesignerProfileEntity> findByDesignerMail(String email);
