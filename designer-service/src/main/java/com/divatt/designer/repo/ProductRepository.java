...
//	Optional<ProductMasterEntity> findById(Integer productId);
	...
	List<ProductMasterEntity> findByDesignerIdAndIsDeletedAndAdminStatusAndIsActive(Integer designerId,
			Boolean isDeleted, String AdminStatus, Boolean isActive);

	Page<ProductMasterEntity> findByIsDeletedAndAdminStatusAndDesignerId(Boolean isDeleted, String AdminStatus,
			Integer DesignerId, Pageable pagingSort);
	...
	Page<ProductMasterEntity> DesignerSearchfindByIsDeletedAndAdminStatusAndDesignerId(String keyword,
			Boolean isDeleted, String AdminStatus, Integer DesignerId, Pageable pagingSort);

	List<ProductMasterEntity> findByIsDeletedAndAdminStatusAndIsActive(Boolean isDeleted, String AdminStatus,
			Boolean IsActive);
	...
	Page<ProductMasterEntity> findByIsDeletedAndDesignerIdAndAdminStatusAndIsActive(Boolean isDeleted,
	...
	Page<ProductMasterEntity> listDesignerProductsearch(String keyword, Boolean isDeleted, Integer designerId,
			Pageable pagingSort);
	...
	Page<ProductMasterEntity> listDesignerProductsearchByAdminStatus(String keyword, Boolean isDeleted,
			Integer designerId, String adminStatus, Pageable pagingSort);

	@Query(value = "{ $or: [ { 'productName' : {$regex:?0,$options:'i'} }, { 'gender' : {$regex:?0,$options:'i'} },{ 'productDescription' : {$regex:?0,$options:'i'} },{ 'productId' : {$regex:?0,$options:'i'} },{ 'isActive' : {$regex:?0,$options:'i'} },{ 'createdOn' : {$regex:?0,$options:'i'} },{ 'age.min' : {$regex:?0,$options:'i'} },{ 'price.indPrice.mrp' : {$regex:?0,$options:'i'} },{ 'price.usPrice.mrp' : {$regex:?0,$options:'i'} }, { 'designer_name' : {$regex:?0,$options:'i'} } ], $and: [ { 'isDeleted' : ?1,'designerId' : ?2, 'adminStatus' : ?3, 'isActive' : ?4 }]}")
	Page<ProductMasterEntity> listDesignerProductsearchByAdminStatusForOos(String keyword, Boolean isDeleted,
			Integer designerId, String adminStatus, Boolean isActive, Pageable pagingSort);

	@Query(value = "{ $or: [ { 'productName' : {$regex:?0,$options:'i'} }, { 'gender' : {$regex:?0,$options:'i'} },{ 'productDescription' : {$regex:?0,$options:'i'} },{ 'productId' : {$regex:?0,$options:'i'} },{ 'isActive' : {$regex:?0,$options:'i'} },{ 'createdOn' : {$regex:?0,$options:'i'} },{ 'age.min' : {$regex:?0,$options:'i'} },{ 'price.indPrice.mrp' : {$regex:?0,$options:'i'} },{ 'price.usPrice.mrp' : {$regex:?0,$options:'i'} },{ 'designer_name' : {$regex:?0,$options:'i'} } ], $and: [ { 'isDeleted' : ?1,'designerId' : ?2 }]}")
	Page<ProductMasterEntity> DesignerSearchfindByIsDeletedAndAdminStatus(String keyword, Boolean isDeleted,
	...
	Integer countByIsDeletedAndAdminStatusAndDesignerIdAndIsActive(Boolean isDeleted, String AdminStatus,
			Long DesignerId, Boolean isActive);
	...
	Page<ProductMasterEntity> SearchAndfindByIsDeletedAndAdminStatus(String keyword, Boolean isDeleted,
			String AdminStatus, Pageable pagingSort);

	@Query(value = "{ $or: [ { 'productName' : {$regex:?0,$options:'i'} }, { 'productDescription' : {$regex:?0,$options:'i'} },{ 'gender' : {$regex:?0,$options:'i'} },{ 'taxPercentage' : {$regex:?0,$options:'i'} },{ 'price.indPrice.mrp' : {$regex:?0,$options:'i'} },{ 'designerName' : {$regex:?0,$options:'i'} },{ 'price.usPrice.mrp' : {$regex:?0,$options:'i'} } ],$and: [ {  'isDeleted' : ?1, 'adminStatus' : ?2}]}")
	Page<ProductMasterEntity> SearchAppAndfindByIsDeletedAndAdminStatus(String keyword, Boolean isDeleted,
			String AdminStatus, Pageable pagingSort);
