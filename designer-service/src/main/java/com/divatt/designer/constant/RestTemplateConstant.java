...
public enum RestTemplateConstant {
	 ...
	 GET_USER_ADDRESS("https://localhost:8082/dev/user/getUserAddress/"),
	 ...
	 INFO_USER("https://localhost:8080/dev/auth/info/USER/"),
	 DEV_CATEGORY("https://localhost:9095/dev/category/"),
